...
public class JwtUtils {
    ...
    private static final long EXPIRATION_TIME_IN_MILLIS = 1000L * 60L * 60L * 24L * 30L * 6L;
    private SecretKey key;

    @Value("${secretJwtString}")
    private String secretJwtString; //Make sure the value in the app properties is 32 characters long
